...
public class SpriteAccessor implements TweenAccessor<Sprite> {
    ...
    public static final int C_WIDTH_HEIGHT = 11;
    public static final int SCALE_X = 12;
    public static final int SCALE_Y = 13;
    ...
    public void setValues(Sprite target, int tweenType, float[] newValues) {
        switch (tweenType) {
            ...
            case C_WIDTH_HEIGHT:
                target.setSize(newValues[0], newValues[1]);
                target.setPosition(target.getX() - target.getWidth() / 2,
