 ...
 * <p/>
 *
 * You need to periodicaly updatePrefs the tween engine, in order to compute the new
 * values. If your tweens are managed, only updatePrefs the manager; else you need
...
public final class Tween extends BaseTween<Tween> {
	 ...
	 * <i>diora.base.Animation.Tweens.equations</i> package, but you can of course
