 ...
 * and for making sure that every callbacks are triggered, even if the updatePrefs
...
+	 * is automatically called once the animation is finished.
	...
	/**
	 * Pauses the tween or timeline. Further updatePrefs calls won't have any effect.
	 */
	public void pause() {
		isPaused = true;
	}
	 ...
	 * TweenManager to updatePrefs objects for you.</b>
	 *
