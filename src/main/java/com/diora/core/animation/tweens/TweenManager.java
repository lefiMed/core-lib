 ...
 * <p/>
 *
 * Just give it a bunch of tweens or timelines and call updatePrefs() periodically,
...
public class TweenManager {
	 ...
	 * Therefore, if you updatePrefs a manager backwards, the tweens or timelines
	...
	/**
	 * Pauses the manager. Further updatePrefs calls won't have any effect.
	 */
	public void pause() {
		isPaused = true;
	}
	 ...
	 * last updatePrefs call. Each tween or timeline manages its local time, and adds
	 * this delta to its local time to updatePrefs itself.
	 * <p/>
	 *
