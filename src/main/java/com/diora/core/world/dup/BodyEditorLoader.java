package com.diora.core.world.dup;
...
public class BodyEditorLoader {
     ...
     */
    public void attachFixture(Body body, String name, FixtureDef fd,Object nameObject, float scale) {
        ...
        for (int i=0, n=rbModel.polygons.size(); i<n; i++) {
            ...
            body.createFixture(fd).setUserData(nameObject);
